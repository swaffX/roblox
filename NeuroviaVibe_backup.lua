...
send = function()
  loadingFrame.Size = UDim2.new(1, -8, 0, 60)
  loadingFrame.BackgroundColor3 = Color3.fromRGB(35,35,40)
  loadingFrame.BorderSizePixel = 0
  loadingFrame.Parent = chat
  corner(loadingFrame, 8)
  
  local loadingLabel = Instance.new('TextLabel')
  loadingLabel.BackgroundTransparency = 1
  loadingLabel.Text = '⏳ Generating plan...'
  loadingLabel.TextColor3 = Color3.fromRGB(160,162,170)
  loadingLabel.TextSize = 12
  loadingLabel.Size = UDim2.new(1, -20, 1, 0)
